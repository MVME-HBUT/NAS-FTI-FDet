...
class FADFCOSHead(torch.nn.Module):
    def __init__(self, cfg, in_channels):
        ...
        if cfg.MODEL.FAD.CLSTOWER:
            ...
            # self.cls_reduce = nn.Conv2d(
            #     cfg.MODEL.FAD.NUM_CHANNELS_CLS*cfg.MODEL.FAD.NUM_NODES_CLS, in_channels, kernel_size=1, stride=1,
            #     padding=0
            # ) 
        ...
        if cfg.MODEL.FAD.BOXTOWER:
            ...
            # self.box_reduce = nn.Conv2d(
            #     cfg.MODEL.FAD.NUM_CHANNELS_CLS*cfg.MODEL.FAD.NUM_NODES_BOX, in_channels, kernel_size=1, stride=1,
            #     padding=0
            # ) 
        else:
            self.bbox_pred = nn.Conv2d(
