...
_C.MODEL.RPN.POST_NMS_TOP_N_TEST = 1000 #1000
...
_C.MODEL.ROI_BOX_HEAD.NUM_CLASSES = 13 #9 #13 #81
...
_C.MODEL.ROI_KEYPOINT_HEAD.NUM_CLASSES = 13 #9 #13 #17
...
# ---------------------------------------------------------------------------- #
_C.MODEL.FAD = CN()
_C.MODEL.FAD.PLOT = True
_C.MODEL.FAD.SEARCH = True

_C.MODEL.FAD.CLSTOWER = False     
_C.MODEL.FAD.NUM_CELLS_CLS = 1     
_C.MODEL.FAD.NUM_NODES_CLS = 3     
_C.MODEL.FAD.NUM_CHANNELS_CLS = 256     

_C.MODEL.FAD.BOXTOWER = False     
_C.MODEL.FAD.NUM_CELLS_BOX = 1     
_C.MODEL.FAD.NUM_NODES_BOX = 3     
_C.MODEL.FAD.NUM_CHANNELS_BOX = 256     

_C.MODEL.FAD.MASKTOWER = False     
_C.MODEL.FAD.NUM_CELLS_MASK = 1     
_C.MODEL.FAD.NUM_NODES_MASK = 3     
_C.MODEL.FAD.NUM_CHANNELS_MASK = 256

_C.MODEL.FAD.GENO_CLS = ["None"]
_C.MODEL.FAD.GENO_BOX = ["None"]
_C.MODEL.FAD.GENO_MASK = ["None"]

_C.MODEL.FAD.CHANNEL_LIST_CLS = []
_C.MODEL.FAD.CHANNEL_LIST_BOX = []
_C.MODEL.FAD.CHANNEL_LIST_MASK = []
_C.MODEL.FAD.GENO_CHANNEL_CLS = []
_C.MODEL.FAD.GENO_CHANNEL_BOX = []
_C.MODEL.FAD.GENO_CHANNEL_MASK = []
_C.MODEL.FAD.USE_CHANNEL_LR = False
_C.MODEL.FAD.CHANNEL_LR_CLS = []
_C.MODEL.FAD.CHANNEL_LR_BOX = []
...
# ---------------------------------------------------------------------------- #
_C.MODEL.FCOS = CN()
_C.MODEL.FCOS.NUM_CLASSES = 13 #9 #13 #81  # the number of classes including background
...
_C.MODEL.RETINANET.NUM_CLASSES = 13 #9 #13 #81
...
# for search
_C.SOLVER.SEARCH = CN()
_C.SOLVER.SEARCH.BASE_LR_ALPHA = 0.0003
_C.SOLVER.SEARCH.FIRST_ORDER = True
...
_C.TENSORBOARD = CN() 
_C.TENSORBOARD.PREFIX = "training_dir/"
